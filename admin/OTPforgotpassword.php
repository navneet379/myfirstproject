    ...
    <div class="container">        
        ...
        <div class="login-block">
			...
			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" >
				<span class="username">OTP:</span>
				<input type="text" name="username" id="uname" class="password" placeholder="OTP" required="">
			
			<span class="username">NEW PASSWORD:</span>
				<input type="password" name="newpassword" id="uname" class="password" placeholder="NEW PASSWORD" required="">
			
			<span class="username">CONFIRM PASSWORD:</span>
				<input type="password" name="cpassword" id="uname" class="password" placeholder="CONFIRM PASSWORD" required="">
