...
<body class="bg-img-num1"> 
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="block" >
                    <div class="header">
                        <h2>Insert Trainer Details</h2>
                    </div>
					<form method="post">
                    <div class="content controls" >
                        <div class="form-row">
                            <div class="col-md-3">T_name:</div>
                            <div class="col-md-9"><input type="text" class="form-control" name="txttname"/></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-3">T_profilepic:</div>
                            <div class="col-md-9"><input type="text" class="form-control" name="txtprofilepic"/></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-3">T_email:</div>
                            <div class="col-md-9"><input type="text" class="form-control" name="textemail"/></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-3">T_contact:</div>
                            <div class="col-md-9"><input type="text" class="form-control" name="txtcontact"/></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-3">T_gender:</div>
                            <div class="col-md-9">
							<input type="text" class="form-control" name="txtgender"/></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-3">T_experience</div>
                            <div class="col-md-9"><input type="text" class="form-control" name="txtexperience"/></div>
                        </div>
						<div class="form-row">
...
if ( isset($_POST["txttname"]) && isset($_POST["txtprofilepic"]) && isset($_POST["textemail"]) && isset($_POST["txtcontact"]) && isset($_POST["txtgender"])&& isset($_POST["txtexperience"])&& isset($_POST["txtdescription"]))
{
	...
	{
		$sql = "insert into trainer(T_name,T_profilepic,T_email,T_contact,T_gender,T_experience,T_description)
		values('".$Tr_name."','".$Tr_profilepic."' ,'".$Tr_email."' ,'".$Tr_contact."','".$Tr_gender."','".$Tr_experience."','".$Tr_descrption."')";
