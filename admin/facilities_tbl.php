            ...
            <div class="col-md-12">
                <div class="block">
                    <div class="header">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<span> <a href="facilities_ins.php"> Add Records </a> </span>
                    </div>
                    <div class="content">
	...
	<th>   Action	 </th>
                            ...
                            <tbody>
                                		<?php
												...
												echo "<td>" . $row['Fac_description'] . "</td>";
												echo "<td> <a href=\"delete_fac.php?id=$row[Fac_id]\"><img
												src=\"img/delete2.png\"   height='25'/> </a> &nbsp; &nbsp;
												<a href=\"facilities_update.php?id=$row[Fac_id]&name=$row[Fac_name]\"><img
