            ...
            <div class="col-md-12">
                <div class="block">
                    <div class="header">
                        <h2>Area Table</h2>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<span><a href="area_ins.php"> Add records </a> </span>
                    </div>
                    <div class="content">
	...
	<th> Action	 </th>
                            ...
                            <tbody>
                                		<?php
								                ...
								                echo "<td> <a href=\"delete_area.php?id=$row[Area_id]\"><img
												src=\"img/delete2.png\"   height='25'/> </a> &nbsp; &nbsp;
												<a href=\"area_update.php?id=$row[Area_id]&name=$row[Area_name]\"><img
