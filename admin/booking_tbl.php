...
<body class="bg-img-num1"> 
            ...
            <div class="col-md-12">
                <div class="block">
                    <div class="header">
                        <h2>Booking Table</h2>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<span> <a href="Reports/index(1).php"> Generate reports </a> </span>
                    </div>
                    <div class="content">
    ...
    <th> Total_amount </th>
	<th> Booking_date </th>
	<th> 	Booking_enddate </th>
	<th> Action	 </th>

                            </thead>
                            <tbody>
                                		<?php
												$sql="select * from booking b join package p join customer c where b.P_id=p.P_id and b.C_id=c.C_id";
												...
												{
												echo "<td> <a href=\"accept.php?id=$row[B_id]\"><img
												src=\"img/right.png\"   height='25'/> </a> &nbsp; &nbsp;
												<a href=\"reject.php?id=$row[B_id]\"><img
												src=\"img/wrong.png\"   height='25'/> </a></td>";
												}
